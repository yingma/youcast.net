...
Call.prototype.isScreenSharing = function() {
    return this.isScreenSharing_ === 'true';
};
...
// Call.prototype.onDisplayMediaSuccess_ = function(stream) {
//     this.localStream_ = stream;
//     if (this.onscreenstreamadded) {
//         this.onscreenstreamadded(stream);
//     }
// };

// Call.prototype.onDisplayMediaError_ = function(error) {
...
Call.prototype.createPcClient_ = function() {
    ...
    this.pcClient_.onnewparticipant = this.onnewparticipant;
...
Call.prototype.enterWhiteboard = function() {
    this.whiteboard_ = true;
};
