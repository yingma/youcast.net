...
// This class implements a signaling channel based on WebSocket. (collider server)
...
SignalingChannel.prototype.register = function(roomId, clientId, isPresenter) {
  if (this.registered_) {
